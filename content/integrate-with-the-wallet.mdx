...
- [SD-JWT VC - Draft 13](https://www.ietf.org/archive/id/draft-ietf-oauth-sd-jwt-vc-13.html) or [ISO 18013-5 mDOC](https://www.iso.org/standard/69084.html) - As the credential format
...
<Callout type="info">Optional: While the EUDI trust ecosystem is still in development, you can get your organization show as trusted when interacting with the Paradym wallet by sending the root X509 certificate to ana@animo.id</Callout>
...
- The wallet currently accepts any X509 certificate, so it's not needed to register your certificate. But it will show as unrecongized (and thus untrusted).
